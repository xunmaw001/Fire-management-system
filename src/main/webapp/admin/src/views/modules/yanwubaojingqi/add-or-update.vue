      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="单位账号" prop="danweizhanghao">
          <el-input v-model="ruleForm.danweizhanghao" 
              placeholder="单位账号" clearable  :readonly="ro.danweizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单位账号" prop="danweizhanghao">
              <el-input v-model="ruleForm.danweizhanghao" 
                placeholder="单位账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单位名称" prop="danweimingcheng">
          <el-input v-model="ruleForm.danweimingcheng" 
              placeholder="单位名称" clearable  :readonly="ro.danweimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单位名称" prop="danweimingcheng">
              <el-input v-model="ruleForm.danweimingcheng" 
                placeholder="单位名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报警器名称" prop="baojingqimingcheng">
          <el-input v-model="ruleForm.baojingqimingcheng" 
              placeholder="报警器名称" clearable  :readonly="ro.baojingqimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报警器名称" prop="baojingqimingcheng">
              <el-input v-model="ruleForm.baojingqimingcheng" 
                placeholder="报警器名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="型号" prop="xinghao">
              <el-input v-model="ruleForm.xinghao" 
                placeholder="型号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="安装时间" prop="anzhuangshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.anzhuangshijian" 
                type="date"
                placeholder="安装时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.anzhuangshijian" label="安装时间" prop="anzhuangshijian">
              <el-input v-model="ruleForm.anzhuangshijian" 
                placeholder="安装时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="保修时间" prop="baoxiushijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baoxiushijian" label="保修时间" prop="baoxiushijian">
              <el-input v-model="ruleForm.baoxiushijian" 
                placeholder="保修时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报警数据" prop="baojingshuju">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="报警数据"
                  v-model="ruleForm.baojingshuju" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baojingshuju" label="报警数据" prop="baojingshuju">
                    <span>{{ruleForm.baojingshuju}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	baojingqimingcheng : false,
	tupian : false,
	xinghao : false,
	anzhuangshijian : false,
	baoxiushijian : false,
	baojingshuju : false,
	sfsh : false,
	shhf : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.danweimingcheng = true;
            continue;
	            	            ...
	            	            if(o=='baojingqimingcheng'){
            this.ruleForm.baojingqimingcheng = obj[o];
	    this.ro.baojingqimingcheng = true;
            continue;
          }
	            	            if(o=='tupian'){
	    ...
	    this.ro.xinghao = true;
            continue;
	            	            ...
	            	            if(o=='anzhuangshijian'){
            this.ruleForm.anzhuangshijian = obj[o];
	    this.ro.anzhuangshijian = true;
            continue;
          }
	            	            if(o=='baoxiushijian'){
	    ...
	    this.ro.baoxiushijian = true;
            continue;
	            	            ...
	            	            if(o=='baojingshuju'){
            this.ruleForm.baojingshuju = obj[o];
	    this.ro.baojingshuju = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                      		if(json.danweizhanghao!=''&&json.danweizhanghao){
              		this.ruleForm.danweizhanghao = json.danweizhanghao
		}
                                  		if(json.danweimingcheng!=''&&json.danweimingcheng){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yanwubaojingqi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yanwubaojingqiCrossAddOrUpdateFlag = false;
                  this.parent.search();
