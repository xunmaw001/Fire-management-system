          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单位邮箱" prop="danweiyouxiang">
          <el-input v-model="ruleForm.danweiyouxiang" 
              placeholder="单位邮箱" clearable  :readonly="ro.danweiyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单位邮箱" prop="danweiyouxiang">
              <el-input v-model="ruleForm.danweiyouxiang" 
                placeholder="单位邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='danweiyouxiang'){
            this.ruleForm.danweiyouxiang = obj[o];
	    this.ro.danweiyouxiang = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaofangdanwei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaofangdanweiCrossAddOrUpdateFlag = false;
                  this.parent.search();
