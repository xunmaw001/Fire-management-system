        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyongfangfa" label="使用方法" prop="shiyongfangfa">
                    <span>{{ruleForm.shiyongfangfa}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="检查记录" prop="jianchajilu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="检查记录"
                  v-model="ruleForm.jianchajilu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianchajilu" label="检查记录" prop="jianchajilu">
                    <span>{{ruleForm.jianchajilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.weihujilu" label="维护记录" prop="weihujilu">
                    <span>{{ruleForm.weihujilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shiyongfangfa = true;
            continue;
	            	            ...
	            	            if(o=='jianchajilu'){
            this.ruleForm.jianchajilu = obj[o];
	    this.ro.jianchajilu = true;
            continue;
          }
	            	            if(o=='weihujilu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaofangshebei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaofangshebeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
